...
在这种情况下需要去掉xml文件中不需要的索引，但是必须要留下Hips或Spine节点，因为这个节点还控制整个模型的位置，如果去掉整个模型就不会运动。例如以下：<br>
&lt;bone ConnectId = "0" name = "Hips"&gt;&lt;/bone&gt;<br>
&lt;bone ConnectId = "3" name = "Spine1"&gt;&lt;/bone&gt;<br>
